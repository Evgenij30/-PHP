...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="wrapper">
			<div id="header">
				<div id="logo">
					<a href="/admin">Админка </span> <span class="cms"></span></a>
				</div>
				<div class="polzovatel">
					<? Model::UserAuth()?>
					<? if ($_SESSION['login_admin']){  echo "Привет : <b>".$_SESSION['login_admin']."</b>";?>
			...
			<div id="page">
				...
				<div id="sidebar">
					<h2>Категории</h2>
                    	   <ul>
                    	     <li><a href="/admin_categoriya/">Редактор категорий</a></li>
                    	   	 <li><a href="/admin_goods">Редактор товаров</a></li>  
